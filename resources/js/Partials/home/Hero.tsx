    ...
    return (
        <>
            ...
            <div className="h-[55vh] w-full relative overflow-hidden">
                {/* white section */}
                <img
                    className={`absolute aspect-[3042/510] max-w-[350vw] translate-x-[50vw] ${allLoaded ? "block" : "hidden"}`}
                ...
                <div
                    id="hero-logo"
                    className={`z-50 absolute w-3/4 sm: aspect-[313/90] top-[15%] left-1/2 -translate-x-1/2`}
                ></div>
                ...
                <div className="hidden sm:visible absolute h-[40vh] aspect-[1086/684] left-1/2 -translate-x-1/2 top-1/2">
                    <div className="relative w-full h-full">
                        <img // blue section
                            ...
                            onLoad={onLoad}
                            className={`absolute z-10 w-full h-full ${allLoaded ? "block" : "hidden"}`}
                        />
                        ...
                        <img // plant
                            ...
                            alt="banner plant"
                            onLoad={onLoad}
                            className={`absolute z-40 w-[6%] left-[17%] top-[40%] opacity-50 ${allLoaded ? "block" : "hidden"}`}
                        />
                        <img // girl
                            src="/assets/images/banner-images/Girl.svg"
                            alt="banner girl"
                            onLoad={onLoad}
                            className={`absolute z-40 w-[14%] bottom-[8%] left-[35%] ${allLoaded ? "block" : "hidden"}`}
                        />
                        <img // boy
                            src="/assets/images/banner-images/MAAAN.svg"
                            alt="banner man"
                            onLoad={onLoad}
                            className={`absolute z-40 w-[28%] right-[20%] bottom-[15%] ${allLoaded ? "block" : "hidden"}`}
                        />
                        <img // monitor
                            src="/assets/images/banner-images/monitor.svg"
                            alt="banner monitor"
                            onLoad={onLoad}
                            className={`-translate-x-1/2 -translate-y-1/2 absolute z-40 w-[20%] left-[55%] top-[45%] ${allLoaded ? "block" : "hidden"}`}
                        />
                    </div>
                </div>
            </div>
