...
vi.mock("@/index", () => ({
    ...
    Images: ({ images }: { images: NonNullable<ProjectPageProps["project"]["data"]["images"]> }) => (
        <div>Images Count: {images.length}</div>
    ),
    Contributors: ({ contributors }: { contributors: ProjectPageProps["project"]["data"]["contributors"] }) => (
